...
export const isGetArticle = (data: any): data is GetArticle =>
    <GetArticle>data instanceof Object && _t.isString((<GetArticle>data).id);
export const isGetArticles = (data: any): data is GetArticles =>
    <GetArticles>data instanceof Object && _t.isOptionalString((<GetArticles>data).user);
...
export const isRemoveArticle = (data: any): data is RemoveArticle =>
    <RemoveArticle>data instanceof Object && _t.isString((<RemoveArticle>data).id);
