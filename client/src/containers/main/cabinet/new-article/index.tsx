...
export default memo((props: CmpProps) => {
    ...
    useEffect(() => {}, [title, description, body, isValid]);
    ...
    return (
        <AddArticle
            ...
            onCompleted={data =>
                data && data.addArticle && data.addArticle.success && props.history.push('/')
            }>
                        ...
                        <Loading loading={loading}>
                            <form
                                ...
                                <div className="new_article__b">
                                    ...
                                    />
                                    {isValid === false && body.length <= 0 && (
                                        <p className="new_article__err">Заполните "Cтатью"!</p>
                                    )}
                                </div>
                                <button className="new_article__btn" type="submit">
                                    Сохранить
                                </button>
                            </form>
                        </Loading>
